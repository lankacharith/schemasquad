...
public class GetCompletedQuests {
    public static void Client_GetCompletedQuests(Scanner scanner) {
        System.out.println("--- Get Completed Quests ---");
        System.out.print("Enter Character name: ");
        String charName = scanner.nextLine().trim().toLowerCase();

        System.out.println(Server_GetCompletedQuests(charName));

    }

    public static String Server_GetCompletedQuests(String charName) {
        ...
        try {
            ...
            "WHERE C.name ILIKE ? AND CQP.iscomplete = True " +
            "ORDER BY Q.ID";
            ...
            if (!found) {
                return "Info: No completed quests found for character '" + charName + "'.";
            }
